...
*/
console.log(pessoa.nomeCompleto()); //Olá! Meu nome é Autobele Silva
...
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
console.log(pessoa.mostrarPeso()); //Eu peso 74Kg
...
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
console.log(pessoa.mostrarAltura()); //Minha altura é 1.62m
...
*/
console.log(pessoa.caminhouQuantosMetros); //19
