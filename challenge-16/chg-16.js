...
var fullName = 'autobele-paulino-da-silva'
...
*/
console.log( '\nMeus amigos:' );
var listaNomes = ['João', 'Maria', 'Roberto', 'Pedro', 'Marcos']
var frase = listaNomes.reduce(function(acumulado, atual, index){
  var separador = listaNomes.length - 1 === index ? ' e ' : ', '
