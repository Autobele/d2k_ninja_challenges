...
var name = ['Au', 'to', 'be', 'le'];

var linguaDoP = name.reduce(function(acumulado, atual, index, array){
...
Array.isArray(justMod20r3) ? console.log(justMod20r3.join(',')) : console.log('Não é um array')
}());
