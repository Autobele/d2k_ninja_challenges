...
text = text.replace(/Manuel Marques de Sousa/g, 'Autobele Silva')
console.log(text);
...
text = text.replace(/brasileiro/, 'piauiense')
console.log(text);
/*
...
text = text.replace(/(O Centauro de Luvas)/, function(capturaTotal, frase){
...
*/
text = "Manuel Marques de Sousa, Conde de Porto Alegre (Rio Grande, 13 de junho de 1804 – Rio de Janeiro, 18 de julho de 1875), apelidado de O Centauro de Luvas, foi um militar, político, abolicionista e monarquista brasileiro.";
